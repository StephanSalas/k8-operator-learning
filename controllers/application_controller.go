...
//+kubebuilder:rbac:groups=cache.example.com,resources=Applications,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.example.com,resources=Applications/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.example.com,resources=Applications/finalizers,verbs=update
...
func (r *ApplicationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !reflect.DeepEqual(podNames, Application.Status.Nodes) {
		Application.Status.Nodes = podNames
...
func (r *ApplicationReconciler) deploymentForApplication(m *cachev1alpha1.Application) *appsv1.Deployment {
